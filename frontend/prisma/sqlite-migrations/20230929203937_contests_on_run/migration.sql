/*
  ...
  - Added the required column `runId` to the `Contest` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Contest" ("exampleId", "explanation", "id", "output1Id", "output2Id", "winningOutputId") SELECT "exampleId", "explanation", "id", "output1Id", "output2Id", "winningOutputId" FROM "Contest";
DROP TABLE "Contest";
