/*
  ...
  - Added the required column `exampleId` to the `Contest` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Contest" ("explanation", "id", "output1Id", "output2Id", "winningOutputId") SELECT "explanation", "id", "output1Id", "output2Id", "winningOutputId" FROM "Contest";
DROP TABLE "Contest";
