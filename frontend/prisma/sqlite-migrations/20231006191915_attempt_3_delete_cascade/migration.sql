...
CREATE TABLE "new_Contest" (
    ...
    CONSTRAINT "Contest_output1Id_fkey" FOREIGN KEY ("output1Id") REFERENCES "Output" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Contest_output2Id_fkey" FOREIGN KEY ("output2Id") REFERENCES "Output" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Contest_winningOutputId_fkey" FOREIGN KEY ("winningOutputId") REFERENCES "Output" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
