      ...
      <Content>
        <article className={classes['documentation']}>
          ...
          <p>
            ...
            currently support rubric style criteria where the evaluation is described in terms of a question and a set
            of predefined answers.
          </p>
          ...
          <p>
            ...
            judge, this could be a question in a Q/A evaluation scenario, or a reference document and a question in a
            RAG Q/A scenario. The response to evaluate is the text that we want the LLM to evaluate, subject to the
            input context. Finally the criteria describes the details of the evaluation itself.
          </p>
