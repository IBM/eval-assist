...
- Please keep your summary less than {max_new_tokens} tokens"""
    ...
    def _get_borderline_criteria(self, criteria_dict):
        ...
        # response schema
        response_schemas = [
            ResponseSchema(name="criteria_name", description="the name of borderline criteria"),
            ResponseSchema(name="criteria_description", description="the description of borderline criteria"),
        ]
        ...
        # get criteria
        criteria_other = self.model.generate_responses([], [query])
    ...
    def _format_prompts(self):
        ...
        if self.task_type == "text":
            ...
            for dimension, criteria_dict in self.rubric.items():
                ...
                # add "other" category
                criteria_dict["other"] = self._get_borderline_criteria(criteria_dict)
